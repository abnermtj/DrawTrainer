...
namespace ChartAndGraph
{
    public class GraphChart : GraphChartBase, ICanvas
    {
        ...
        private HashSet<string> mOccupiedCateogies = new HashSet<string>();
        private Dictionary<string, Dictionary<int, BillboardText>> mTexts = new Dictionary<string, Dictionary<int, BillboardText>>();
        private HashSet<BillboardText> mActiveTexts = new HashSet<BillboardText>();
        private Dictionary<string, CategoryObject> mCategoryObjects = new Dictionary<string, CategoryObject>();
        private List<DoubleVector3> mTmpData = new List<DoubleVector3>();
        private List<DoubleVector4> mClipped = new List<DoubleVector4>();
        private List<Vector4> mTransformed = new List<Vector4>();
        private List<int> mTmpToRemove = new List<int>();
        private GameObject mFixPosition = null;
        ...
        private GameObject CreateRectMask(Rect viewRect)
        {
        ...
        private void AddBillboardText(string cat, int index, BillboardText text)
        {
            if (text.UIText != null)
