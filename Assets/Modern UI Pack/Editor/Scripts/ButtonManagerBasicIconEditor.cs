                    ...
                    else if (tempUIM == null)
                    {
                        ...
                        else
                        {
                            ...
                            if (GUILayout.Button("Restore UI Manager", customSkin.button))
                            {
                                ...
                                try
                                {
                                    uimb.buttonType = UIManagerButton.ButtonType.BasicOnlyIcon;
                                    uimb.basicOnlyIconFilled = bTarget.gameObject.GetComponent<UnityEngine.UI.Image>();
                                    uimb.basicOnlyIconIcon = bTarget.transform.Find("Icon").GetComponent<UnityEngine.UI.Image>();
                                }
