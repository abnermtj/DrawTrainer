                    ...
                    else if (tempUIM == null)
                    {
                        ...
                        else
                        {
                            ...
                            if (GUILayout.Button("Restore UI Manager", customSkin.button))
                            {
                                ...
                                try
                                {
                                    uimb.buttonType = UIManagerButton.ButtonType.Basic;
                                    uimb.basicFilled = bTarget.gameObject.GetComponent<UnityEngine.UI.Image>();
                                    uimb.basicText = bTarget.transform.Find("Text").GetComponent<TMPro.TextMeshProUGUI>();
                                }
